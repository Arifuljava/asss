...
public class CallAdapter extends RecyclerView.Adapter<CallAdapter.myview> {
    public List<ContactModel> data;
    FirebaseFirestore firebaseFirestore;
    FirebaseAuth firebaseAuth;
    String detecor,gettingtext;

    public CallAdapter(List<ContactModel> data) {
        this.data = data;
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.hhh,parent,false);
    ...
    public void onBindViewHolder(@NonNull myview holder, final int position) {
        ...
        holder.kinadam.setText("ফোন নম্বর : "+data.get(position).getNumber()+"" +
                "\nকলিং টাইম : "+data.get(position).getUuid());
