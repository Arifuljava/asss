...
public class NewsPaperHome extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news_paper_home);
    ...
    public void world(View view) {
        Intent intent=new Intent(getApplicationContext(),NewspaperList.class);
